...
import DbConnection from "./routes/Settings/DbConnection";
    ...
    <Router>
      <Routes>
        ...
        >
          ...
          <Route
            path="/profile"
            element={<Profile setHeaderDescription={setHeaderDescription} />}
          />
          <Route
            path="/clientes"
            element={
              <ClientsIndex setHeaderDescription={setHeaderDescription} />
            }
          />
          <Route
          ...
          <Route
            path="/creditos"
            element={
              <CreditsIndex setHeaderDescription={setHeaderDescription} />
            }
          />
          <Route
            path="/creditos/show/:id"
            element={<CreditShow setHeaderDescription={setHeaderDescription} />}
          />
          <Route
            path="/config/conexion"
            element={
              <DbConnection setHeaderDescription={setHeaderDescription} />
            }
          />
